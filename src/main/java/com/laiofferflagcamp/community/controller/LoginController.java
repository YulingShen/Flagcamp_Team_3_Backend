...
import com.laiofferflagcamp.community.entity.reqeust.LoginRequestBody;
import com.laiofferflagcamp.community.entity.response.LoginResponseBody;
import com.laiofferflagcamp.community.service.LoginService;
...
public class LoginController {
    ...
    public void login(@RequestBody LoginRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (!firstname.isEmpty()) {
            ...
            session.setAttribute("username", requestBody.getUserId());
